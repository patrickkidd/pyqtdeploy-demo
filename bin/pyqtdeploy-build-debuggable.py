""" Useful as a debug target for pyqtdeploy-build. """
...
if os.name == 'posix':
    ...
    sys.argv += ['--verbose', '--resources', '12', '--target', 'macos-64', 'pyqtdeploy-demo.pdt']
else:
    ...
    sys.argv += ['--verbose', '--resources', '12', '--target', 'win-64', 'pyqtdeploy-demo.pdt']
